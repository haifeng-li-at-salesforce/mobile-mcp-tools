...
To create new Android apps, the `forcedroid create` command repurposes one of two Mobile SDK template projects. You can find both projects in the [github.com/forcedotcom/SalesforceMobileSDK-Templates](https://github.com/forcedotcom/SalesforceMobileSDK-Templates) GitHub repo.
...
To create specialized templates, use the `forcedroid createwithtemplate` command.
...
- **AndroidNativeLoginTemplate**: Demonstrates how to set up native login. When forcedroid createwithtemplate prompts for the repo URI, enter `AndroidNativeLoginTemplate`.
