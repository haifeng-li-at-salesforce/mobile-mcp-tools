# Migrate All Apps from 13.0 to 13.1

Mobile SDK 13.1 migration is easiest if you use the Salesforce CLI plugin or the Mobile SDK npm scripts.

Before you begin upgrading, read about new 13.1 features in [What’s New in Mobile SDK 13.1](gs-whatsnew.md).
...
- Native iOS (Swift, Objective-C)
  ...
  - :
    ...
    - Consider adopting new features. See [What’s New in Mobile SDK 13.1](gs-whatsnew.md).
